...
//reader
rd::Wrapper<AbstractEntity> AbstractEntity::readUnknownInstance(SerializationCtx const& ctx, Buffer const & buffer, RdId const& unknownId, int32_t size)
{
	return rd::Wrapper<AbstractEntity>();
}
