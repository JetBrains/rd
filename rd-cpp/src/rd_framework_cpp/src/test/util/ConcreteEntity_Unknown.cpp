...
//primary ctor
ConcreteEntity_Unknown::ConcreteEntity_Unknown(std::wstring filePath, RdId unknownId, Buffer::ByteArray unknownBytes): AbstractEntity(std::move(filePath)), IUnknownInstance(std::move(unknownId)), unknownBytes(std::move(unknownBytes)) { initialize(); }
//reader
