...
void CrossTestAllEntities::fireAll(const demo::DemoModel& model, const demo::ExtModel& extModel)
{
	...
	auto scalar = demo::MyScalar(false, 98, 32000, 1'000'000'000, -2'000'000'000'000'000'000, 3.14f, -123456789.012345678,
		std::numeric_limits<uint8_t>::max() - 1, (std::numeric_limits<uint16_t>::max()) - 1,
		std::numeric_limits<uint32_t>::max() - 1, std::numeric_limits<uint64_t>::max() - 1, demo::MyEnum::cpp,
