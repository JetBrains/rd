...
namespace Test.Lifetimes.Utils
{
    public class CastToTest
    {
        ...
        public void TestReinterpretCastValueTypes()
        {
            ...
            Assert.AreEqual(AddUpdateRemove.Update, CastTo<AddUpdateRemove>.ReinterpretCastFrom(updateOrdinal));
            Assert.AreEqual(AddUpdateRemove.Remove, CastTo<AddUpdateRemove>.ReinterpretCastFrom(removeOrdinal));
        }
        ...
        public void TestReinterpretCastReferenceTypes()
        {
            ...
            var reinterpreted = CastTo<Tuple<uint,uint>>.ReinterpretCastFrom(@from);
