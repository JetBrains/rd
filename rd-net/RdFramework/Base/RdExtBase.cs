...
namespace JetBrains.Rd.Base
{
  public abstract class RdExtBase : RdReactiveBase
  {
    ...
    protected override void Init(Lifetime lifetime, IProtocol parentIProto, SerializationCtx ctx)
    {
      ...
      var extWire = InitAndGetExtWireInternal(parentProto);
      ...
      lifetime.TryBracket(() =>
        {
          ...
          BeforeAdviseInternal(parentProto);
    ...
    private protected abstract void BeforeAdviseInternal(Protocol parentProto);
    ...
    private protected abstract void OnReadyInternal(IWire parentWire);
    private protected abstract void OnDisconnectedInternal(IWire parentWire);

    private protected abstract IWire InitAndGetExtWireInternal(Protocol parentProtocol);
  ...
  public abstract class DefaultExtBase : RdExtBase
  {
    ...
    private protected override IWire InitAndGetExtWireInternal(Protocol parentProtocol)
    {
      myExtWire.RealWire = parentProtocol.Wire;
      return myExtWire;
    }

    private protected override void OnReadyInternal(IWire parentWire)
    {
      SendState(parentWire, ExtState.Ready);
    }

    private protected override void OnDisconnectedInternal(IWire parentWire)
    {
      SendState(parentWire, ExtState.Disconnected);
    }

    private protected override void BeforeAdviseInternal(Protocol parentProto)
    {
