...
public ref struct JetNotNullConditionalInterpolatedStringHandler
{
  private JetConditionalInterpolatedStringHandler myHandler;

  public bool IsEnabled => myHandler.IsEnabled;

  public JetNotNullConditionalInterpolatedStringHandler(
    int literalLength,
    int formattedCount,
    object? obj,
    out bool isEnabled)
  {
    myHandler = new JetConditionalInterpolatedStringHandler(literalLength, formattedCount, obj != null , out isEnabled);
  }
