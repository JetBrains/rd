...
public ref struct JetLogVerboseInterpolatedStringHandler
{
  private JetLogLevelInterpolatedStringHandler myHandler;

  public bool IsEnabled => myHandler.IsEnabled;

  public JetLogVerboseInterpolatedStringHandler(
    int literalLength,
    int formattedCount,
    ILog logger,
    out bool isEnabled)
  {
    myHandler = new JetLogLevelInterpolatedStringHandler(literalLength, formattedCount, logger, LoggingLevel.VERBOSE, out isEnabled);
  }
