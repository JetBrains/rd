...
public ref struct JetLogTraceInterpolatedStringHandler
{
  private JetLogLevelInterpolatedStringHandler myHandler;

  public bool IsEnabled => myHandler.IsEnabled;

  public JetLogTraceInterpolatedStringHandler(
    int literalLength,
    int formattedCount,
    ILog logger,
    out bool isEnabled)
  {
    myHandler = new JetLogLevelInterpolatedStringHandler(literalLength, formattedCount, logger, LoggingLevel.TRACE, out isEnabled);
  }
