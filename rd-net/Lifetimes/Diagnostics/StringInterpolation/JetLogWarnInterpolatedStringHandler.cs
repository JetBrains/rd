...
public ref struct JetLogWarnInterpolatedStringHandler
{
  private JetLogLevelInterpolatedStringHandler myHandler;

  public bool IsEnabled => myHandler.IsEnabled;

  public JetLogWarnInterpolatedStringHandler(
    int literalLength,
    int formattedCount,
    ILog logger,
    out bool isEnabled)
  {
    myHandler = new JetLogLevelInterpolatedStringHandler(literalLength, formattedCount, logger, LoggingLevel.WARN, out isEnabled);
  }
