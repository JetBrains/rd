...
namespace org.example
{
  ...
  public class AsyncPrimitivesExt : RdExtBase
  {
    ...
    //primary constructor
    internal static AsyncPrimitivesExt CreateInternal()
    {
      return new AsyncPrimitivesExt();
    }
    ...
    public static Type PointcutType => typeof(AsyncPrimitivesRoot);
  ...
  public static class AsyncPrimitivesRootAsyncPrimitivesExtEx
  {
    public static AsyncPrimitivesExt GetAsyncPrimitivesExt(this IProtocol protocol)
    {
      return protocol.GetOrCreateExtension(() => AsyncPrimitivesExt.CreateInternal());
    }
