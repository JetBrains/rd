...
namespace Org.TestRoot1
{
  ...
  public class Solution2 : RdExtBase
  {
    ...
    //primary constructor
    internal static Solution2 CreateInternal()
    {
    ...
    public static Type PointcutType => typeof(TestRoot1);
  ...
  public static class TestRoot1Solution2Ex
  {
    public static Solution2 GetSolution2(this IProtocol protocol)
    {
      return protocol.GetOrCreateExtension(() => Solution2.CreateInternal());
    }
