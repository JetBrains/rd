...
namespace org.example
{
  ...
  public class ExampleModelNova : RdExtBase
  {
    ...
    //primary constructor
    internal static ExampleModelNova CreateInternal()
    {
      return new ExampleModelNova();
    }
    ...
    public static Type PointcutType => typeof(ExampleRootNova);
  ...
  public static class ExampleRootNovaExampleModelNovaEx
  {
    public static ExampleModelNova GetExampleModelNova(this IProtocol protocol)
    {
      return protocol.GetOrCreateExtension(() => ExampleModelNova.CreateInternal());
    }
  }
