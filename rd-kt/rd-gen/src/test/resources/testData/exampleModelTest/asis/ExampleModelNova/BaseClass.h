...
// </auto-generated>
//------------------------------------------------------------------------------
#ifndef BASECLASS_GENERATED_H
#define BASECLASS_GENERATED_H
...
// abstract
class BaseClass : public rd::IPolymorphicSerializable, public rd::RdBindableBase {
...
public:
    // primary ctor
    explicit BaseClass(int32_t baseField_);
    ...
    // reader
    static rd::Wrapper<BaseClass> readUnknownInstance(rd::SerializationCtx& ctx, rd::Buffer & buffer, rd::RdId const& unknownId, int32_t size);
...
public:
    // equality operators
    friend bool operator==(const BaseClass &lhs, const BaseClass &rhs);
    friend bool operator!=(const BaseClass &lhs, const BaseClass &rhs);
    // hash code trait
    // type name trait
...
public:
    // external to string
    friend std::string to_string(const BaseClass & value);
};
