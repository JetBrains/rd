...
// </auto-generated>
//------------------------------------------------------------------------------
#ifndef DERIVEDCLASS_GENERATED_H
#define DERIVEDCLASS_GENERATED_H
...
public:
    // primary ctor
    DerivedClass(bool derivedField_, int32_t baseField_);
    ...
    // reader
    static DerivedClass read(rd::SerializationCtx& ctx, rd::Buffer & buffer);
...
public:
    // equality operators
    friend bool operator==(const DerivedClass &lhs, const DerivedClass &rhs);
    friend bool operator!=(const DerivedClass &lhs, const DerivedClass &rhs);
    // hash code trait
    // type name trait
...
public:
    // external to string
    friend std::string to_string(const DerivedClass & value);
};
...
#endif // DERIVEDCLASS_GENERATED_H
