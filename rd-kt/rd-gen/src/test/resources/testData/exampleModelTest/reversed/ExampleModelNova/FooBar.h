...
// </auto-generated>
//------------------------------------------------------------------------------
#ifndef FOOBAR_GENERATED_H
#define FOOBAR_GENERATED_H
...
class FooBar : public rd::IPolymorphicSerializable, public rd::RdBindableBase {
...
public:
    // primary ctor
    explicit FooBar(rd::Wrapper<Baz> a_);
    ...
    // reader
    static FooBar read(rd::SerializationCtx& ctx, rd::Buffer & buffer);
...
public:
    // external to string
    friend std::string to_string(const FooBar & value);
};
