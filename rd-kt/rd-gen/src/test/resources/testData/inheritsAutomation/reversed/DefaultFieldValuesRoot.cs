...
namespace DefaultFieldValuesRoot
{
  ...
  /// <summary>
  /// <p>Generated from: DefaultFieldValuesTest.kt:16</p>
  /// </summary>
  public class DefaultFieldValuesRoot : RdExtBase
  {
    ...
    public DefaultFieldValuesRoot(Lifetime lifetime, IProtocol protocol) : this()
    {
      ...
      Bind(lifetime, protocol, "DefaultFieldValuesRoot");
    }
  ...
  /// <summary>
  /// <p>Generated from: DefaultFieldValuesTest.kt:24</p>
  /// </summary>
  public sealed class TestClass : RdBindableBase
  {
    ...
    private TestClass(
      ...
      [CanBeNull] [Optional] [DefaultParameterValue(null)] int? cOptional,
  ...
  public sealed class TestStruct : IPrintable, IEquatable<TestStruct>
  {
    ...
    public TestStruct(
      ...
      [CanBeNull] [Optional] [DefaultParameterValue(null)] int? sOptional,
