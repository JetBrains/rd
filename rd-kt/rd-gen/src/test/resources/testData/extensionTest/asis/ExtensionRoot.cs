...
namespace ExtensionRoot
{
  ...
  public class ExtensionRoot : RdExtBase
  {
    ...
    //private fields
    //primary constructor
    internal static ExtensionRoot CreateInternal()
    {
  ...
  public static class ProtocolExtensionRootEx
  {
    public static ExtensionRoot GetExtensionRoot(this IProtocol protocol)
    {
      return protocol.GetOrCreateExtension(() => ExtensionRoot.CreateInternal());
    }
  }
