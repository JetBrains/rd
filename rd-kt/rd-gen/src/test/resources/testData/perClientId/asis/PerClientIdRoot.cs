...
namespace JetBrains.Platform.Tests.Cases.RdFramework.PerClientId
{
  ...
  public class PerClientIdRoot : DefaultExtBase
  {
    ...
    //primary constructor
    internal static PerClientIdRoot CreateInternal()
    {
      return new PerClientIdRoot();
    }
  ...
  public static class ProtocolPerClientIdRootEx
  {
    public static PerClientIdRoot GetPerClientIdRoot(this IProtocol protocol)
    {
      return protocol.GetOrCreateExtension(() => PerClientIdRoot.CreateInternal());
    }
  }
