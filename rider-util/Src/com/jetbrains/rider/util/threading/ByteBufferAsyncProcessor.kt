...
import com.jetbrains.rider.util.blockingAddUnique
...
class ByteBufferAsyncProcessor(val id : String, val chunkSize: Int = ByteBufferAsyncProcessor.DefaultChunkSize, val processor: (ByteArraySlice) -> Unit) {
    ...
    protected val log = LogFactory.getLog(ByteBufferAsyncProcessor::class.java)
        ...
        synchronized(lock) {
            ...
            while (ptr < count) {
                ...
                if (available > 0) {
                    ...
                    System.arraycopy(newData, ptr, freeChunk.data, freeChunk.ptr, copylen)
